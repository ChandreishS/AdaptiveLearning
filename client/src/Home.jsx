...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: white;}
        #sidebar { min-width: 250px; max-width: 250px; min-height: 100vh; background: #1f2937; color: white; transition: all 0.3s;}
        #sidebar.collapsed { min-width: 60px; max-width: 60px; overflow-x: hidden;}
        #sidebar .nav-link { color: #d1d5db;}
        #sidebar .nav-link:hover { background-color: #4b5563; color: white;}
        #sidebar.collapsed .nav-link span { display: none;}
        #content { transition: margin-left 0.3s; margin-left: 250px;}
        #content.collapsed { margin-left: 60px;}
        .calendar-day { cursor: pointer; padding: 10px; border-radius: 5px; text-align: center;}
        .calendar-day:hover { background-color: #e5e7eb;}
        .calendar-day.today { background-color: #0d6efd; color: white;}
        .calendar-day.event { position: relative;}
        .calendar-day.event::after { content: ''; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); width: 6px; height: 6px; background-color: #0d6efd; border-radius: 50%;}
      `}</style>
      ...
      <div className="d-flex">
        ...
        >
          ...
          <ul className="nav nav-pills flex-column">
            ...
            <li className="nav-item mb-2">
              <Link to="/grades" className="nav-link d-flex align-items-center">
                {/* My Grades Icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        >
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div className="d-flex align-items-center">
              <img src="src/assets/connected.png" alt="Logo" width="40" height="40" className="rounded-circle me-3" />
              <h1 className="h4 mb-0">
                Welcome to <strong>ConnectedX</strong>
              </h1>
            </div>
            <div className="d-flex align-items-center gap-3">
              <input type="search" className="form-control form-control-sm" placeholder="Search" style={{ width: "200px" }} />
          ...
          {/* Summary Cards (Use Link for navigation) */}
                ...
                <div className="card border-success">
                  <div className="card-body d-flex align-items-center">
                    <div className="me-3 bg-success text-white rounded-circle p-3">
                      {/* Grades Icon */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-journal-check" viewBox="0 0 16 16">
                        <path fillRule="evenodd"
                          d="M10.854 6.146a.5.5 0 0 0-.708 0L7.5 8.793 6.354 7.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0 0-.708z" />
                        <path d="M3 1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z" />
                      </svg>
          ...
          {/* Page Widgets: Calendar, Connections, Chat, To Do List (buttons link to Messages) */}
          <div className="row g-4">
                ...
                <div className="card-body">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item d-flex align-items-center">
                      <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Anna"
                      ...
                      <Link to="/messages" className="btn btn-sm btn-primary">Message</Link>
                    </li>
                    <li className="list-group-item d-flex align-items-center">
                      <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Mark"
                        className="rounded-circle me-3" width="40" height="40" />
                      <div className="flex-grow-1">
                        <div><strong>Mark Williams</strong></div>
                        <small className="text-muted">Offline</small>
                      </div>
                      <button className="btn btn-sm btn-secondary" disabled>Message</button>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-lg-5">
              {/* Chat and To Do List code unchanged */}
            </div>
          </div>
        </div>
      </div>
